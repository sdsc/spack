...
class Orca(Package):
    ...
    url      = "file://{0}/orca_4_0_1_2_linux_x86-64_shared_openmpi202.tar.zst".format(os.getcwd())

    version('4.2.1', sha256='ff3a703c6b8e8073382e8be87dbffbc908ea04263ced9f363c5532efc4009ddf',
            expand=False)
    ...
    def url_for_version(self, version):
        out = "file://{0}/orca_{1}_linux_x86-64_shared_openmpi314.tar.zst"
    ...
    def install(self, spec, prefix):
        ...
        zstd = which('zstd')
        zstd('--force', '-d', self.stage.archive_file, '-o', vername + '.tar')
