...
class Cairo(AutotoolsPackage):
    ...
    variant('gobject', default=True, description="Enable cairo's gobject functions feature")
    ...
    variant('svg', default=True, description="Enable cairo's SVN functions feature")
