...
class Relion(CMakePackage, CudaPackage):
    ...
    url = "https://github.com/3dem/relion/archive/3.1.4.zip"

    version("4.0.0", sha256="0987e684e9d2dfd630f1ad26a6847493fe9fcd829ec251d8bc471d11701d51dd")
    version("3.1.4", sha256="c7b668879fa06bcb854f2f131970d9747320f75b45e335f937bc0d7088bd1c13", preferred=True)
