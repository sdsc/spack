...
class Amdlibflame(LibflameBase):
    ...
    variant("enable-aocl-blas", default=False, when="@4.1.0:", 
            description="Enables tight coupling with AOCL-BLAS library in order to use AOCL-BLAS internal routines")
    variant("vectorization", default="auto", when="@4.2:", values=("auto", "avx2", "avx512", "none"), multi=False,
