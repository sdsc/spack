...
class Arrayfire(CMakePackage, CudaPackage):
    ...
    version("master")
    version("3.9.0", commit="b59a1ae535da369db86451e5b28a7bc0eaf3e84a", submodules=True, tag="v3.9.0")
    version("3.8.3", commit="987d5675ad95729feb0d007b90ec136d58e3e6ad", submodules=True, tag="v3.8.3")
    version("3.8.1", commit="823e8e399fe8c120c6ec7ec75f09e6106b3074ca", submodules=True, tag="v3.8.1")
