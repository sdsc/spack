...
class Namd(MakefilePackage, CudaPackage):
                ...
                fh.write(
                    "\n".join(
                        [
                            ...
                            "CHARMARCH = {0}".format(self.spec["charmpp"].charmarch + '-smp'),
    ...
    def _edit_arch_target_based(self, spec, prefix):
        ...
        with working_dir("arch"):
            ...
            replace = [
                [r"^CHARMARCH = .*$", "CHARMARCH = {0}".format(self.spec["charmpp"].charmarch + '-smp')],
    ...
    def edit(self, spec, prefix):
        ...
        #charm_options = spec["charmpp"].variants["smp"].value
        #if charm_options:
        #    opts.append("--charm-arch " + self.spec["charmpp"].charmarch + "-smp")
