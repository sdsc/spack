    ...
    def install(self, spec, prefix):
        ...
        if '+mpi' in spec:
            ...
            if spec.satisfies('^intel-mpi'):
                options.append("-mpiinc=%s" % join_path(spec['mpi'].prefix,'compilers_and_libraries','linux','mpi','intel64','include'))
                options.append("-mpilib=%s" % join_path(spec['mpi'].prefix,'compilers_and_libraries','linux','mpi','intel64','lib'))
            else:
