...
class Vcftools(AutotoolsPackage):
    ...
    def test(self):
        ...
        with working_dir(prefix.examples):
            output=Executable(join_path(prefix.bin,'vcftools'))('--vcf','cmp-test-a.vcf','--diff','cmp-test-b.vcf',output=str,error=str)
            teststring='After filtering, kept 6 out of a possible 6 Sites'
            with open('/tmp/vcftools.output','w') as fp:
