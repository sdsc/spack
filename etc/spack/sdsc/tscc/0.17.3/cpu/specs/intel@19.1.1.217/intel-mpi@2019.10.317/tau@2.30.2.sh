...
# Build currently failing on the following error ...
#
#      12    Unset ParaProf's cubeclasspath...
#     13    Unset Perfdmf cubeclasspath...
#     14    Testing directory /home/mkandes/cm/shared/apps/spack/0.17.3/cpu/opt/
...
#           pps/spack/0.17.3/cpu/opt/spack/linux-rocky8-zen2/intel-19.1.3.304/in
...
export CFLAGS=-gcc-name=/cm/shared/apps/spack/0.17.3/cpu/opt/spack/linux-rocky9-cascadelake/gcc-11.2.0/gcc-8.5.0-w6lov36mdw33cg7qm7ekuusp2bbmt6lu/bin/gcc
export CXXFLAGS=-gcc-name=/cm/shared/apps/spack/0.17.3/cpu/opt/spack/linux-rocky9-cascadelake/gcc-11.2.0/gcc-8.5.0-w6lov36mdw33cg7qm7ekuusp2bbmt6lu/bin/gcc
