...
#[mkandes@login02 ~]$ spack --show-cores=minimized spec -l gdb@11.1 % gcc@.2.0 ~gold ~ld ~lto +python ~quad ~source-highlight ~tui +xz "^python@3.8.12/$(spack find --format '{hash:7}' python@3.8.12 % ${SPACK_COMPILER})" 
#Input spec
#--------------------------------
