...
declare -xr SPACK_DEPENDENCIES="^r@4.0.2/$(spack find --format '{hash:7}' r@4.0.2 % ${SPACK_COMPILER}) ^cairo@1.16.0/$(spack find --format '{hash:7}' cairo@1.16.0 % ${SPACK_COMPILER} +X)"
