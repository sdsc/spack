...
#SBATCH --job-name=upcxx@2021.9.0
...
declare -xr SPACK_PACKAGE='upcxx@2021.9.0'
declare -xr SPACK_COMPILER='gcc@10.2.0'
declare -xr SPACK_VARIANTS="~mpi~cuda~gasnet"
...
sbatch --dependency="afterok:${SLURM_JOB_ID}" 'vcftools@0.1.14.sh'
