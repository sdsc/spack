...
declare -xr SPACK_DEPENDENCIES="^openblas@0.3.17/$(spack find --format '{hash:7}' openblas@0.3.17 % ${SPACK_COMPILER} ~ilp64 threads=openmp) ^openmpi@3.1.6/$(spack find --format '{hash:7}' openmpi@3.1.6 % ${SPACK_COMPILER})"
