...
declare -xr SPACK_VARIANTS='~adios2 ~advanced_debug +cuda cuda_arch=60 ~development_files +examples +hdf5 ~ipo ~kits +mpi +opengl2 ~osmesa ~python +python3 ~qt ~shared'
