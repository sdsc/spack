...
#t+wrapper-rpath cuda_arch=60,75,80,86fabrics=verbs schedulers=slurm ^cuda@11.2.2%gcc@8.5.0 cflags="-O2 -march=native" cxxflags="-O2 -march=native" fflags="-O2 -march=nat
