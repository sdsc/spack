...
#ld: /home/mkandes/cm/shared/apps/spack/0.15.4/gpu/opt/spack/linux-centos8-skylake_avx512/gcc-8.3.1/intel-19.0.5.281-ugebwxc62iwwmer3mloyn2hyaebeawxg/compilers_and_libraries_2020.2.254/linux/bin/intel64/../../lib/LLVMgold.so: error loading plugin: libimf.so: cannot open shared object file: No such file or directory
