...
#    '/home/mkandes/cm/shared/apps/spack/0.17.1/cpu/opt/spack/linux-rocky8-zen2/gcc-10.2.0/perl-5.32.0-aqkfsadolq2xm6uar2cjxlgordnxp3sm/bin/perl' './install-tl' '-scheme' 'small' '-repository' 'https://ctan.math.washington.edu/tex-archive/systems/texlive/tlnet/' '-portable' '-profile' '/tmp/tmp7qjdb59f'
