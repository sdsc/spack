...
#  condition(3414)
#  dependency_condition(3414,"openfoam","cgal")
#  dependency_type(3414,"link")
#  imposed_constraint(3414,"version_satisfies","cgal",":4")
