...
#SBATCH --job-name=petsc@3.13.4-complex
...
declare -xr SPACK_VARIANTS='~mpi ~hdf5 ~hypre ~superlu-dist +complex'
...
sbatch --dependency="afterok:${SLURM_JOB_ID}" 'slepc@3.13.4.sh'
