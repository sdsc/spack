...
declare -xr SPACK_DEPENDENCIES="^intel-mpi@2019.8.254/$(spack find --format '{hash:7}' intel-mpi@2019.8.254 % ${SPACK_COMPILER}) ^papi@6.0.0.1/$(spack find --format '{hash:7}' papi@6.0.0.1 % ${SPACK_COMPILER})"
