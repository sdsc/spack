...
declare -xr SPACK_DEPENDENCIES="^mvapich2@2.3.4/$(spack find --format '{hash:7}' mvapich2@2.3.4 % ${SPACK_COMPILER}) ^python@3.8.5/$(spack find --format '{hash:7}' python@3.8.5 % ${SPACK_COMPILER})"
