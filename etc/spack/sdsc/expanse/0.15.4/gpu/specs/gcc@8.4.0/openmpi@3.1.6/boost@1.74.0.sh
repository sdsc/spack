...
declare -xr SPACK_DEPENDENCIES="^openmpi@3.1.6/$(spack find --format '{hash:7}' openmpi@3.1.6 % ${SPACK_COMPILER}) ^py-numpy@1.19.2/$(spack find --format '{hash:7}' py-numpy@1.19.2 % ${SPACK_COMPILER}) ^openblas@0.3.10/$(spack find --format '{hash:7}' openblas@0.3.10 % ${SPACK_COMPILER} +ilp64 threads=none)"
