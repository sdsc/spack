...
declare -xr SPACK_DEPENDENCIES="^intel-mpi@2019.8.254/$(spack find --format '{hash:7}' intel-mpi@2019.8.254 % ${SPACK_COMPILER}) ^python@3.8.5/$(spack find --format '{hash:7}' python@3.8.5 % ${SPACK_COMPILER})"
