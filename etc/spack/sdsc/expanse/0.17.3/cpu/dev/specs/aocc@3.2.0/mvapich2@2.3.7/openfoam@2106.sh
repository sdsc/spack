...
declare -xr SPACK_DEPENDENCIES="^mvapich2@2.3.7/$(spack find --format '{hash:7}' mvapich2@2.3.7 % ${SPACK_COMPILER}) ^adios2@2.7.1/$(spack find --format '{hash:7}' adios2@2.7.1 % ${SPACK_COMPILER} +mpi ^mvapich2@2.3.7) ^cgal@4.13/$(spack find --format '{hash:7}' cgal@4.13 % ${SPACK_COMPILER}) ^fftw@3.3.10/$(spack find --format '{hash:7}' fftw@3.3.10 % ${SPACK_COMPILER} ~mpi ~openmp) ^kahip@3.11/$(spack find --format '{hash:7}' kahip@3.11 % ${SPACK_COMPILER} ^mvapich2@2.3.7) ^scotch@6.1.1/$(spack find --format '{hash:7}' scotch@6.1.1 % ${SPACK_COMPILER} +mpi ^mvapich2@2.3.7) ^zoltan@3.83/$(spack find --format '{hash:7}' zoltan@3.83 % ${SPACK_COMPILER} ~fortran +mpi +parmetis ^mvapich2@2.3.7)"
