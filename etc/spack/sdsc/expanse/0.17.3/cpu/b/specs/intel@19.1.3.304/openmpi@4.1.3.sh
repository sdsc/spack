...
#tic+thread_multiple+vt+wrapper-rpath fabrics=ucx schedulers=slurm ^lustre@2.15.2 ^rdma-core@43.0@28.0 ^slurm@21.08.8 ^ucx@1.10.1 is unsatisfiable, conflicts are:
...
#3+static+vt+wrapper-rpath fabrics=ucx schedulers=slurm ^lustre@2.15.2 ^rdma-core@43.0@28.0 ^slurm@21.08.8 ^ucx@1.10.1 is unsatisfiable, conflicts are:
#  Unsatisfied conditional variants cannot be set
