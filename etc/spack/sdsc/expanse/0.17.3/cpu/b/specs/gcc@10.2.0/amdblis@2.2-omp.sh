...
time -p spack spec --long --namespaces --types amdblis@2.2 % gcc@10.2.0 +blas +cblas +shared +static threads=openmp "^python@3.8.5/$(spack find --format '{hash:7}' python@3.8.5 % ${SPACK_COMPILER})"
if [[ "${?}" -ne 0 ]]; then
