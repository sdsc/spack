...
declare -xr SPACK_VARIANTS='+cuda cuda_arch=70 +fortran ~ipo ~rocm +shared'
declare -xr SPACK_DEPENDENCIES="^cuda@10.2.89/$(spack find --format '{hash:7}' cuda@10.2.89 % ${SPACK_COMPILER}) ^openblas@0.3.18/$(spack find --format '{hash:7}' openblas@0.3.18 % ${SPACK_COMPILER} ~ilp64 threads=none)"
