...
#    './bootstrap.sh' '--prefix=/cm/shared/apps/spack/0.17.3/gpu/a/opt/spack/linux-rocky8-cascadelake/intel-19.1.3.304/boost-1.77.0-n3ralcuxunocme5fu2vr4ims4mtf66hb' '--with-toolset=intel-linux' '--with-libraries=exception,mpi,filesystem,math,log,locale,date_time,program_options,regex,iostreams,random,thread,serialization,chrono,wave,test,graph,system,atomic,timer,graph_parallel' '--without-icu'
#
