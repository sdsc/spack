...
time -p spack spec --long --namespaces --types libxc@5.1.5 % gcc@10.2.0 +cuda cuda_arch=70,80 ~shared "^cuda@11.2.2/$(spack find --format '{hash:7}' cuda@11.2.2 % ${SPACK_COMPILER})"
if [[ "${?}" -ne 0 ]]; then
