...
declare -xr SPACK_PACKAGE='gdb@14.2'
declare -xr SPACK_COMPILER='gcc@8.5.0'
declare -xr SPACK_VARIANTS='~gold ~ld ~lto ~quad ~source-highlight ~tui +xz'
declare -xr SPACK_DEPENDENCIES='' #"^sqlite@3.43.2/$(spack find --format '{hash:7}' sqlite@3.43.2 % ${SPACK_COMPILER})"
