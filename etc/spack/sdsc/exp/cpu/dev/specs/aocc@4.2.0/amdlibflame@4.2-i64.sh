...
#SBATCH --job-name=amdlibflame@4.2-i64
...
declare -xr SPACK_DEPENDENCIES="^amdblis@4.2/$(spack find --format '{hash:7}' amdblis@4.2 % ${SPACK_COMPILER} +ilp64 threads=none) ^cmake@3.27.7/$(spack find --format '{hash:7}' cmake@3.27.7 % ${SPACK_COMPILER} arch=linux-rocky8-zen2)"
