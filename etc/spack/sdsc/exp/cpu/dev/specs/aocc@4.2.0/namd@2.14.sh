...
declare -xr SPACK_DEPENDENCIES="^charmpp@6.10.2/$(spack find --format '{hash:7}' charmpp@6.10.2 % ${SPACK_COMPILER} backend=multicore) ^amdfftw@4.2/$(spack find --format '{hash:7}' amdfftw@4.2 % ${SPACK_COMPILER} ~mpi ~openmp)"
