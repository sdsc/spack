...
#SBATCH --job-name=py-mpi4py@4.0.0
...
declare -xr SPACK_PACKAGE='py-mpi4py@4.0.0'
declare -xr SPACK_COMPILER='gcc@13.3.0'
declare -xr SPACK_VARIANTS=''
declare -xr SPACK_MPI='openmpi@4.1.6'
declare -xr SPACK_DEPENDENCIES="^${SPACK_MPI}/$(spack find --format '{hash:7}' ${SPACK_MPI} % ${SPACK_COMPILER}) ^python@3.11.9/$(spack find --format '{hash:7}' python@3.11.9 % ${SPACK_COMPILER})"
