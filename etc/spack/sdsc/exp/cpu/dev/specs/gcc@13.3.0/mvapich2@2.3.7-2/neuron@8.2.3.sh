...
declare -xr SPACK_DEPENDENCIES="^${SPACK_MPI}/$(spack find --format '{hash:7}' ${SPACK_MPI} % ${SPACK_COMPILER}) ^py-numpy@2.1.2/$(spack find --format '{hash:7}' py-numpy@2.1.2 % ${SPACK_COMPILER} ^openblas@0.3.28 ~ilp64 threads=none)"
