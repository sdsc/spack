...
#SBATCH --job-name=amdblis@4.2-i64-omp
...
declare -xr SPACK_PACKAGE='amdblis@4.2'
declare -xr SPACK_COMPILER='gcc@13.3.0'
declare -xr SPACK_VARIANTS='~aocl_gemm +blas +cblas +ilp64 +suphandling threads=openmp'
