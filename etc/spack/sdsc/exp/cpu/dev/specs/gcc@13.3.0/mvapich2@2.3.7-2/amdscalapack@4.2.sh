...
declare -xr SPACK_DEPENDENCIES="^amdlibflame@4.2/$(spack find --format '{hash:7}' amdlibflame@4.2 % ${SPACK_COMPILER} ~ilp64 threads=none) ^mvapich2@2.3.7-2/$(spack find --format '{hash:7}' mvapich2@2.3.7-2 % ${SPACK_COMPILER})"
