...
#SBATCH --job-name=openblas@0.3.28-i64-omp
...
declare -xr SPACK_PACKAGE='openblas@0.3.28'
declare -xr SPACK_COMPILER='gcc@13.3.0'
declare -xr SPACK_VARIANTS='~bignuma ~consistent_fpcsr +fortran +ilp64 +locking +pic +shared threads=openmp'
