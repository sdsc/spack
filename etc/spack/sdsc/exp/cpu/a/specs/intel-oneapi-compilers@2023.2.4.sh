...
#SBATCH --job-name=intel-oneapi-compilers@2023.2.4
...
declare -xr SPACK_PACKAGE='intel-oneapi-compilers@2023.2.4'
...
sed -i "s|PATH_TO_ICX_2023_2_4|$(spack location -i 'intel-oneapi-compilers@2023.2.4')/compiler/latest/linux/bin/icx|g" "${SPACK_INSTANCE_DIR}/etc/spack/compilers.yaml"
