...
EIGEN_JOB_ID="$(sbatch --dependency="afterok:${GCC_JOB_ID}" 'eigen@3.4.0.sh' | grep -o '[[:digit:]]*')"
  ...
  HWLOC_JOB_ID="$(sbatch --dependency="afterok:${EIGEN_JOB_ID}" 'hwloc@2.9.1.sh' | grep -o '[[:digit:]]*')"
...
INTEL_ONEAPI_MKL_JOB_ID="$(sbatch --dependency="afterok:${INTEL_ONEAPI_MPI_JOB_ID}" 'intel-oneapi-mkl@2023.2.0.sh' | grep -o '[[:digit:]]*')"
  ELPA_JOB_ID="$(sbatch --dependency="afterok:${INTEL_ONEAPI_MKL_JOB_ID}:${PYTHON_JOB_ID}" 'elpa@2024.03.001.sh' | grep -o '[[:digit:]]*')"
