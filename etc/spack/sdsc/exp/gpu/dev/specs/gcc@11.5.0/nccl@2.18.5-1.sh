...
declare -xr SPACK_PACKAGE='nccl@2.18.5-1'
declare -xr SPACK_COMPILER='gcc@11.5.0'
declare -xr SPACK_VARIANTS='+cuda cuda_arch=70,80'
declare -xr SPACK_DEPENDENCIES="^cuda@11.8.0/$(spack find --format '{hash:7}' cuda@11.8.0 % ${SPACK_COMPILER}) ^rdma-core"
