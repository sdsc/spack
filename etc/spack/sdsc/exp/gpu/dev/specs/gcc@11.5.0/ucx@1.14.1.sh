...
declare -xr SPACK_VARIANTS='~assertions ~backtrace_detail +cma +cuda cuda_arch=70,80 +dc ~debug +dm +gdrcopy ~gtest +ib_hw_tm ~java +knem ~logging +mlx5_dv +numa +openmp +optimizations ~parameter_checking +pic +rc +rdmacm ~rocm +thread_multiple ~ucg +ud +verbs ~vfs +xpmem'
