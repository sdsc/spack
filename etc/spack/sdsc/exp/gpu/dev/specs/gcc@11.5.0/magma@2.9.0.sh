...
declare -xr SPACK_VARIANTS='+cuda +fortran ~rocm +shared cuda_arch=70,80'
declare -xr SPACK_DEPENDENCIES="^cuda@11.8.0/$(spack find --format '{hash:7}' cuda@11.8.0 % ${SPACK_COMPILER}) ^openblas@0.3.28/$(spack find --format '{hash:7}' openblas@0.3.28 % ${SPACK_COMPILER} ~ilp64 threads=none)"
