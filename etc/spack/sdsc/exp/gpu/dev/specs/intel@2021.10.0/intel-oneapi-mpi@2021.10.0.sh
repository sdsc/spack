...
#SBATCH --job-name=intel-oneapi-mpi@2021.10.0
...
declare -xr SPACK_PACKAGE='intel-oneapi-mpi@2021.10.0'
declare -xr SPACK_COMPILER='intel@2021.10.0'
declare -xr SPACK_VARIANTS='+envmods ~external-libfabric ~generic-names ~ilp64'
