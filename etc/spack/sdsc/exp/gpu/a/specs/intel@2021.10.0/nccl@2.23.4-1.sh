...
declare -xr SPACK_PACKAGE='nccl@2.23.4-1'
declare -xr SPACK_COMPILER='intel@2021.10.0'
declare -xr SPACK_VARIANTS='+cuda cuda_arch=70,80,90'
declare -xr SPACK_DEPENDENCIES="^cuda@12.6.3/$(spack find --format '{hash:7}' cuda@12.6.3 % ${SPACK_COMPILER}) ^rdma-core"
